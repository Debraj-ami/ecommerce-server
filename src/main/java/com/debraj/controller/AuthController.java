...
import com.debraj.config.JwtProvider;
import com.debraj.exception.UserException;
import com.debraj.model.Cart;
import com.debraj.model.User;
import com.debraj.repository.UserRepository;
import com.debraj.request.LoginRequest;
import com.debraj.response.AuthResponse;
import com.debraj.service.CartService;
import com.debraj.service.CustomUserServiceImplementation;




@CrossOrigin(origins = "https://novacart-bay.vercel.app")
@RestController
@RequestMapping("/auth")
